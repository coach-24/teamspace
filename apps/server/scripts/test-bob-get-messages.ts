...
const main = async () => {
  ...
  console.log("\n📨 Bob is trying to read Secret Project messages...");
  ...
  if (
    ...
    console.log("\n🎉 BOB PRIVATE MESSAGE READ RBAC PASSED!");
    console.log("Bob cannot read the private channel messages.");
  } else {
    console.log("\n❌ BOB PRIVATE MESSAGE READ RBAC FAILED.");
    process.exit(1);
  }
};
